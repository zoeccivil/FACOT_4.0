...
def _apply_safe_menu_styles(app: QApplication) -> None:
    """
    Fuerza paleta y stylesheet seguros para que la barra de menú y menús
    se vean correctamente en el exe (evitar texto blanco sobre fondo claro).
    """
    try:
        app.setStyle("Fusion")
    except Exception:
    ...
    # Estilos explícitos para QMenuBar/QMenu
    app.setStyleSheet("""
    QMenuBar {
        background: #f8fafc;
        color: #1e293b;
